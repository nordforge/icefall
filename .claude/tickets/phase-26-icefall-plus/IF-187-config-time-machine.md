...
Version every environment variable, container config, and build setting change in SQLite with timestamps. Browse the full history, diff any two points in time, and restore any previous configuration state with one click.
